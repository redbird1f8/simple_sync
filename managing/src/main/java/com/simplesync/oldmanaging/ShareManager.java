...
import com.simplesync.ShareWriter;
import com.simplesync.ShareXMLReader;
import com.simplesync.ShareXMLWriter;
 ...
 * можно будет получить только из ConfigManagerOld(Не стоит на это обращать внимание)
 */
